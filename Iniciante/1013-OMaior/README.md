...
<img src="[https://latex.codecogs.com/svg.image?&space:MaiorAB=\frac{(A+B+abs(AB))}{2}](https://latex.codecogs.com/svg.image?&space;MaiorAB=\frac{(A+B+abs(AB))}{2})" title="\bg_white MaxAB" />
